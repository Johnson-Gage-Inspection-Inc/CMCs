...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("-0.0015 to +0.0015 in", "-0.0015", "in", "0.0015", "in"),  # Plus/minus parsing
        ...
        # Edge Cases
        ("(200 to 10 000) psi", "200", "psi", "10000", "psi",),  # Handles extra spaces in numbers
...
def test_parse_range(input_text, expected_min, expected_min_unit, expected_max, expected_max_unit):
    assert parse_range(input_text) == (expected_min, expected_min_unit, expected_max, expected_max_unit)
